...
public class ActeRecEnfantAdulterinDto{
    ...
    public String getConsentementEpouseNom() {
        return consentementEpouseNom;
    }

    public void setConsentementEpouseNom(String consentementEpouseNom) {
        this.consentementEpouseNom = consentementEpouseNom;
    }

    public String getConsentementEpousePrenoms() {
        return consentementEpousePrenoms;
    }

    public void setConsentementEpousePrenoms(String consentementEpousePrenoms) {
        this.consentementEpousePrenoms = consentementEpousePrenoms;
    }

    public String getConsentementEpouseType() {
        return consentementEpouseType;
    }

    public void setConsentementEpouseType(String consentementEpouseType) {
        this.consentementEpouseType = consentementEpouseType;
    }
