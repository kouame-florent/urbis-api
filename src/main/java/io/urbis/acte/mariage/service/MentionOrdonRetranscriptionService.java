...
@ApplicationScoped
@Transactional
public class MentionOrdonRetranscriptionService {
    ...
    public void createMention(@NotNull MentionOrdonRetranscriptionDto dto){
        ...
        MentionOrdonRetranscription mention = new MentionOrdonRetranscription();
    ...
    public void modifierMention(@NotNull MentionOrdonRetranscriptionDto dto){
         
        MentionOrdonRetranscription mention = MentionOrdonRetranscription.findById(dto.getId());
        if(mention == null){
    ...
    public void deleteMention(String mentionID){
        MentionOrdonRetranscription.deleteById(mentionID);
    }
    
    public Set<MentionOrdonRetranscriptionDto> findByActeMariage(@NotBlank String acteMariageID){
        ActeMariage acte = ActeMariage.findById(acteMariageID);
        List<MentionOrdonRetranscription> mentions = MentionOrdonRetranscription.list("acteMariage", acte);
    ...
    public String mentionRecenteTexte(ActeMariage acte){
        ...
        TypedQuery<MentionOrdonRetranscription> query =  em.createNamedQuery("MentionOrdonRetranscription.findMostRecent", 
                MentionOrdonRetranscription.class);
        query.setParameter("acteMariage",acte);
          
        try{
            MentionOrdonRetranscription mention = query.getSingleResult();
    ...
    public MentionOrdonRetranscriptionDto  mapToDto(@NotNull MentionOrdonRetranscription mention){
        MentionOrdonRetranscriptionDto  dto = new MentionOrdonRetranscriptionDto ();
