 ...
 * @author florent
 */
public class ActeDecesEtatDto {
    
    private String id;    
   
    private String acteDecesID;
    ...
    public String getActeDecesID() {
        return acteDecesID;
    }

    public void setActeDecesID(String acteDecesID) {
        this.acteDecesID = acteDecesID;
    }
